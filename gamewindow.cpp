...
GameWindow::GameWindow(const char* windowName, Uint16 width, Uint16 height) throw (const SDLError) : fpsDisplay(nullptr)
{
...
{
	TTF_Font* Sans = TTF_OpenFont("/usr/share/fonts/truetype/liberation/LiberationMono-Regular.ttf", 10); //this opens a font style and sets a size
